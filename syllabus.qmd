...
1. Getting Started: What is spatial analysis and how do we do it in `R`?

2. Spatial Data Operations in R: Prepping geospatial data for use in `R`

3. Statistical Workflows for Spatial Data: Putting spatial data to work!

4. Visualizing Spatial Data: Everyone loves a map...
...
**Final Project (50pts): ** The final project asks you to conduct an entire spatial analysis from layout to results. Grades on the final project are based on your objectives and your self-assessment of whether or not you achieved those objectives. Your first draft of the final project will be due __December 5__. I'll make comments based on the same categories for the homework revision and you'll have time to revise your submission prior to the final deadline of __December 14__. 
