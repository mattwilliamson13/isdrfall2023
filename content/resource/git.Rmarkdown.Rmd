...
[Understanding the logic of git](https://www.sbf5.com/~cduan/technical/git/): provides a relatively accessible explanation of the various operations in git and links that t0 commonly used syntax. 
