...
var.cld  <- gstat::variogram(res ~ 1, aq.sum, cloud = TRUE, cutoff=1000000)
...
dat.fit  <- gstat::fit.variogram(var.smpl, fit.ranges = FALSE, fit.sills = FALSE, gstat::vgm(psill=18, model="Sph", range=500000, nugget=0))
